...
case "$env" in
"development")
  secrets_variable=("secrets/google-credential.json.dev")
  ;;
"staging")
  secrets_variable=("secrets/google-credential.json.stg")
  ;;
"production")
  secrets_variable=("secrets/google-credential.json.prd")
  ;;
esac
