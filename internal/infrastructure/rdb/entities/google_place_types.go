...
func (q googlePlaceTypeQuery) One(ctx context.Context, exec boil.ContextExecutor) (*GooglePlaceType, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entities: failed to execute a one query for google_place_types")
	}
...
func (q googlePlaceTypeQuery) All(ctx context.Context, exec boil.ContextExecutor) (GooglePlaceTypeSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "entities: failed to assign all query results to GooglePlaceType slice")
	}
...
func (q googlePlaceTypeQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entities: failed to count google_place_types rows")
	}
...
func (q googlePlaceTypeQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entities: failed to check if google_place_types exists")
	}
...
func FindGooglePlaceType(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*GooglePlaceType, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entities: unable to select from google_place_types")
	}
...
func (o *GooglePlaceType) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entities: no google_place_types provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to insert into google_place_types")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to populate default values for google_place_types")
	}
...
func (o *GooglePlaceType) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("entities: unable to update google_place_types, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to update google_place_types row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: failed to get rows affected by update for google_place_types")
	}
...
func (q googlePlaceTypeQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to update all for google_place_types")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to retrieve rows affected for google_place_types")
	}
...
func (o GooglePlaceTypeSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to update all in googlePlaceType slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to retrieve rows affected all in update all googlePlaceType")
	}
	return rowsAff, nil
}
...
func (o *GooglePlaceType) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("entities: no google_place_types provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("entities: unable to upsert google_place_types, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to upsert for google_place_types")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to retrieve unique values for google_place_types")
	}
...
func (o *GooglePlaceType) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("entities: no GooglePlaceType provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to delete from google_place_types")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: failed to get rows affected by delete for google_place_types")
	}
...
func (q googlePlaceTypeQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("entities: no googlePlaceTypeQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to delete all from google_place_types")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: failed to get rows affected by deleteall for google_place_types")
	}
...
func (o GooglePlaceTypeSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to delete all from googlePlaceType slice")
	}
...
func (o *GooglePlaceTypeSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to reload all in GooglePlaceTypeSlice")
	}
...
func GooglePlaceTypeExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "entities: unable to check if google_place_types exists")
	}
