...
func (q googlePlaceOpeningPeriodQuery) One(ctx context.Context, exec boil.ContextExecutor) (*GooglePlaceOpeningPeriod, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entities: failed to execute a one query for google_place_opening_periods")
	}
...
func (q googlePlaceOpeningPeriodQuery) All(ctx context.Context, exec boil.ContextExecutor) (GooglePlaceOpeningPeriodSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "entities: failed to assign all query results to GooglePlaceOpeningPeriod slice")
	}
...
func (q googlePlaceOpeningPeriodQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entities: failed to count google_place_opening_periods rows")
	}
...
func (q googlePlaceOpeningPeriodQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entities: failed to check if google_place_opening_periods exists")
	}
...
func FindGooglePlaceOpeningPeriod(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*GooglePlaceOpeningPeriod, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entities: unable to select from google_place_opening_periods")
	}
...
func (o *GooglePlaceOpeningPeriod) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entities: no google_place_opening_periods provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to insert into google_place_opening_periods")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to populate default values for google_place_opening_periods")
	}
...
func (o *GooglePlaceOpeningPeriod) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("entities: unable to update google_place_opening_periods, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to update google_place_opening_periods row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: failed to get rows affected by update for google_place_opening_periods")
	}
...
func (q googlePlaceOpeningPeriodQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to update all for google_place_opening_periods")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to retrieve rows affected for google_place_opening_periods")
	}
...
func (o GooglePlaceOpeningPeriodSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to update all in googlePlaceOpeningPeriod slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to retrieve rows affected all in update all googlePlaceOpeningPeriod")
	}
	return rowsAff, nil
}
...
func (o *GooglePlaceOpeningPeriod) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("entities: no google_place_opening_periods provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("entities: unable to upsert google_place_opening_periods, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to upsert for google_place_opening_periods")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to retrieve unique values for google_place_opening_periods")
	}
...
func (o *GooglePlaceOpeningPeriod) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("entities: no GooglePlaceOpeningPeriod provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to delete from google_place_opening_periods")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: failed to get rows affected by delete for google_place_opening_periods")
	}
...
func (q googlePlaceOpeningPeriodQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("entities: no googlePlaceOpeningPeriodQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to delete all from google_place_opening_periods")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: failed to get rows affected by deleteall for google_place_opening_periods")
	}
...
func (o GooglePlaceOpeningPeriodSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to delete all from googlePlaceOpeningPeriod slice")
	}
...
func (o *GooglePlaceOpeningPeriodSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to reload all in GooglePlaceOpeningPeriodSlice")
	}
...
func GooglePlaceOpeningPeriodExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "entities: unable to check if google_place_opening_periods exists")
	}
