...
func (q placeQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Place, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entities: failed to execute a one query for places")
	}
...
func (q placeQuery) All(ctx context.Context, exec boil.ContextExecutor) (PlaceSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "entities: failed to assign all query results to Place slice")
	}
...
func (q placeQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entities: failed to count places rows")
	}
...
func (q placeQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entities: failed to check if places exists")
	}
...
func FindPlace(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Place, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entities: unable to select from places")
	}
...
func (o *Place) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entities: no places provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to insert into places")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to populate default values for places")
	}
...
func (o *Place) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("entities: unable to update places, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to update places row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: failed to get rows affected by update for places")
	}
...
func (q placeQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to update all for places")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to retrieve rows affected for places")
	}
...
func (o PlaceSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to update all in place slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to retrieve rows affected all in update all place")
	}
	return rowsAff, nil
}
...
func (o *Place) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("entities: no places provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("entities: unable to upsert places, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to upsert for places")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to retrieve unique values for places")
	}
...
func (o *Place) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("entities: no Place provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to delete from places")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: failed to get rows affected by delete for places")
	}
...
func (q placeQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("entities: no placeQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to delete all from places")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: failed to get rows affected by deleteall for places")
	}
...
func (o PlaceSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to delete all from place slice")
	}
...
func (o *PlaceSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to reload all in PlaceSlice")
	}
...
func PlaceExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "entities: unable to check if places exists")
	}
