...
func (q planCandidateSetMetaDataCategoryQuery) One(ctx context.Context, exec boil.ContextExecutor) (*PlanCandidateSetMetaDataCategory, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entities: failed to execute a one query for plan_candidate_set_meta_data_categories")
	}
...
func (q planCandidateSetMetaDataCategoryQuery) All(ctx context.Context, exec boil.ContextExecutor) (PlanCandidateSetMetaDataCategorySlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "entities: failed to assign all query results to PlanCandidateSetMetaDataCategory slice")
	}
...
func (q planCandidateSetMetaDataCategoryQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entities: failed to count plan_candidate_set_meta_data_categories rows")
	}
...
func (q planCandidateSetMetaDataCategoryQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entities: failed to check if plan_candidate_set_meta_data_categories exists")
	}
...
func FindPlanCandidateSetMetaDataCategory(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*PlanCandidateSetMetaDataCategory, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entities: unable to select from plan_candidate_set_meta_data_categories")
	}
...
func (o *PlanCandidateSetMetaDataCategory) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entities: no plan_candidate_set_meta_data_categories provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to insert into plan_candidate_set_meta_data_categories")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to populate default values for plan_candidate_set_meta_data_categories")
	}
...
func (o *PlanCandidateSetMetaDataCategory) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("entities: unable to update plan_candidate_set_meta_data_categories, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to update plan_candidate_set_meta_data_categories row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: failed to get rows affected by update for plan_candidate_set_meta_data_categories")
	}
...
func (q planCandidateSetMetaDataCategoryQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to update all for plan_candidate_set_meta_data_categories")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to retrieve rows affected for plan_candidate_set_meta_data_categories")
	}
...
func (o PlanCandidateSetMetaDataCategorySlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to update all in planCandidateSetMetaDataCategory slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to retrieve rows affected all in update all planCandidateSetMetaDataCategory")
	}
	return rowsAff, nil
}
...
func (o *PlanCandidateSetMetaDataCategory) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("entities: no plan_candidate_set_meta_data_categories provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("entities: unable to upsert plan_candidate_set_meta_data_categories, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to upsert for plan_candidate_set_meta_data_categories")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to retrieve unique values for plan_candidate_set_meta_data_categories")
	}
...
func (o *PlanCandidateSetMetaDataCategory) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("entities: no PlanCandidateSetMetaDataCategory provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to delete from plan_candidate_set_meta_data_categories")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: failed to get rows affected by delete for plan_candidate_set_meta_data_categories")
	}
...
func (q planCandidateSetMetaDataCategoryQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("entities: no planCandidateSetMetaDataCategoryQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to delete all from plan_candidate_set_meta_data_categories")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: failed to get rows affected by deleteall for plan_candidate_set_meta_data_categories")
	}
...
func (o PlanCandidateSetMetaDataCategorySlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to delete all from planCandidateSetMetaDataCategory slice")
	}
...
func (o *PlanCandidateSetMetaDataCategorySlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to reload all in PlanCandidateSetMetaDataCategorySlice")
	}
...
func PlanCandidateSetMetaDataCategoryExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "entities: unable to check if plan_candidate_set_meta_data_categories exists")
	}
