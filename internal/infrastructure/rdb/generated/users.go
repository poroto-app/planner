...
func (r *userR) GetPlans() PlanSlice {
	if r == nil {
		return nil
	}
	return r.Plans
...
var (
	userAllColumns            = []string{"id", "firebase_uid", "name", "email", "photo_url", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"id", "firebase_uid", "name", "email", "photo_url"}
...
func (o *User) PlacePhotos(mods ...qm.QueryMod) placePhotoQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`place_photos`.`user_id`=?", o.ID),
	)
...
func (o *User) Plans(mods ...qm.QueryMod) planQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
...
func (userL) LoadPlacePhotos(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`place_photos.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadPlans(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`plans`),
		qm.WhereIn(`plans.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddPlacePhotos(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PlacePhoto) error {
	var err error
...
// Sets related.R.User appropriately.
func (o *User) AddPlans(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Plan) error {
	var err error
	for _, rel := range related {
		if insert {
...
// SetPlans removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's Plans accordingly.
// Replaces o.R.Plans with related.
// Sets related.R.User's Plans accordingly.
func (o *User) SetPlans(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Plan) error {
	query := "update `plans` set `user_id` = null where `user_id` = ?"
	...
	return o.AddPlans(ctx, exec, insert, related...)
}

// RemovePlans relationships from objects passed in.
// Removes related items from R.Plans (uses pointer comparison, removal does not keep order)
// Sets related.R.User.
func (o *User) RemovePlans(ctx context.Context, exec boil.ContextExecutor, related ...*Plan) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		for i, ri := range o.R.Plans {
			...
			ln := len(o.R.Plans)
			if ln > 1 && i < ln-1 {
				o.R.Plans[i] = o.R.Plans[ln-1]
			}
			o.R.Plans = o.R.Plans[:ln-1]
			break
		}
	}
...
func (o UserSlice) InsertAll(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to insert all from user slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by insertall for users")
	}
...
func (o UserSlice) UpsertAll(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) (int64, error) {
	...
	nzUniques := queries.NonZeroDefaultSet(mySQLUserUniqueColumns, o[0])
	if len(nzUniques) == 0 {
	...
	if !updateColumns.IsNone() && len(update) == 0 {
		return 0, errors.New("generated: unable to upsert users, could not build update column list")
	}
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to upsert for users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by upsert for users")
	}
...
func (s UserSlice) LoadPlacePhotosByPage(ctx context.Context, e boil.ContextExecutor, mods ...qm.QueryMod) error {
	return s.LoadPlacePhotosByPageEx(ctx, e, DefaultPageSize, mods...)
}
func (s UserSlice) LoadPlacePhotosByPageEx(ctx context.Context, e boil.ContextExecutor, pageSize int, mods ...qm.QueryMod) error {
	if len(s) == 0 {
		return nil
	}
...
func (s UserSlice) GetLoadedPlacePhotos() PlacePhotoSlice {
...
func (s UserSlice) LoadPlansByPage(ctx context.Context, e boil.ContextExecutor, mods ...qm.QueryMod) error {
	return s.LoadPlansByPageEx(ctx, e, DefaultPageSize, mods...)
}
func (s UserSlice) LoadPlansByPageEx(ctx context.Context, e boil.ContextExecutor, pageSize int, mods ...qm.QueryMod) error {
	if len(s) == 0 {
		return nil
	}
	for _, chunk := range chunkSlice[*User](s, pageSize) {
...
func (s UserSlice) GetLoadedPlans() PlanSlice {
