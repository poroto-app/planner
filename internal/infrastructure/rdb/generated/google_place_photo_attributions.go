...
func AddGooglePlacePhotoAttributionHook(hookPoint boil.HookPoint, googlePlacePhotoAttributionHook GooglePlacePhotoAttributionHook) {
	...
	case boil.AfterSelectHook:
		googlePlacePhotoAttributionAfterSelectMu.Lock()
		...
		googlePlacePhotoAttributionAfterSelectMu.Unlock()
	case boil.BeforeInsertHook:
		googlePlacePhotoAttributionBeforeInsertMu.Lock()
		...
		googlePlacePhotoAttributionBeforeInsertMu.Unlock()
	case boil.AfterInsertHook:
		googlePlacePhotoAttributionAfterInsertMu.Lock()
		...
		googlePlacePhotoAttributionAfterInsertMu.Unlock()
	case boil.BeforeUpdateHook:
		googlePlacePhotoAttributionBeforeUpdateMu.Lock()
		...
		googlePlacePhotoAttributionBeforeUpdateMu.Unlock()
	case boil.AfterUpdateHook:
		googlePlacePhotoAttributionAfterUpdateMu.Lock()
		...
		googlePlacePhotoAttributionAfterUpdateMu.Unlock()
	case boil.BeforeDeleteHook:
		googlePlacePhotoAttributionBeforeDeleteMu.Lock()
		...
		googlePlacePhotoAttributionBeforeDeleteMu.Unlock()
	case boil.AfterDeleteHook:
		googlePlacePhotoAttributionAfterDeleteMu.Lock()
		...
		googlePlacePhotoAttributionAfterDeleteMu.Unlock()
	case boil.BeforeUpsertHook:
		googlePlacePhotoAttributionBeforeUpsertMu.Lock()
		...
		googlePlacePhotoAttributionBeforeUpsertMu.Unlock()
	case boil.AfterUpsertHook:
		googlePlacePhotoAttributionAfterUpsertMu.Lock()
		...
		googlePlacePhotoAttributionAfterUpsertMu.Unlock()
	}
}
...
func (q googlePlacePhotoAttributionQuery) One(ctx context.Context, exec boil.ContextExecutor) (*GooglePlacePhotoAttribution, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "generated: failed to execute a one query for google_place_photo_attributions")
	}
...
func (q googlePlacePhotoAttributionQuery) All(ctx context.Context, exec boil.ContextExecutor) (GooglePlacePhotoAttributionSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "generated: failed to assign all query results to GooglePlacePhotoAttribution slice")
	}
...
func (q googlePlacePhotoAttributionQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to count google_place_photo_attributions rows")
	}
...
func (q googlePlacePhotoAttributionQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "generated: failed to check if google_place_photo_attributions exists")
	}
...
func (googlePlacePhotoAttributionL) LoadPhotoReferenceGooglePlacePhotoReference(ctx context.Context, e boil.ContextExecutor, singular bool, maybeGooglePlacePhotoAttribution interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		args[object.PhotoReference] = struct{}{}
		...
		for _, obj := range slice {
			...
			args[obj.PhotoReference] = struct{}{}
	...
	query := NewQuery(
		...
		qm.WhereIn(`google_place_photo_references.photo_reference in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func FindGooglePlacePhotoAttribution(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*GooglePlacePhotoAttribution, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "generated: unable to select from google_place_photo_attributions")
	}
...
func (o *GooglePlacePhotoAttribution) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("generated: no google_place_photo_attributions provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to insert into google_place_photo_attributions")
	}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to populate default values for google_place_photo_attributions")
	}
...
func (o *GooglePlacePhotoAttribution) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("generated: unable to update google_place_photo_attributions, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to update google_place_photo_attributions row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by update for google_place_photo_attributions")
	}
...
func (q googlePlacePhotoAttributionQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to update all for google_place_photo_attributions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to retrieve rows affected for google_place_photo_attributions")
	}
...
func (o GooglePlacePhotoAttributionSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to update all in googlePlacePhotoAttribution slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to retrieve rows affected all in update all googlePlacePhotoAttribution")
	}
	return rowsAff, nil
}
...
func (o *GooglePlacePhotoAttribution) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("generated: no google_place_photo_attributions provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("generated: unable to upsert google_place_photo_attributions, could not build update column list")
		}

		ret := strmangle.SetComplement(googlePlacePhotoAttributionAllColumns, strmangle.SetIntersect(insert, update))
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to upsert for google_place_photo_attributions")
	}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to retrieve unique values for google_place_photo_attributions")
	}
...
func (o *GooglePlacePhotoAttribution) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("generated: no GooglePlacePhotoAttribution provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to delete from google_place_photo_attributions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by delete for google_place_photo_attributions")
	}
...
func (q googlePlacePhotoAttributionQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("generated: no googlePlacePhotoAttributionQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to delete all from google_place_photo_attributions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by deleteall for google_place_photo_attributions")
	}
...
func (o GooglePlacePhotoAttributionSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to delete all from googlePlacePhotoAttribution slice")
	}
...
func (o *GooglePlacePhotoAttributionSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to reload all in GooglePlacePhotoAttributionSlice")
	}
...
func GooglePlacePhotoAttributionExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "generated: unable to check if google_place_photo_attributions exists")
	}
...
var (
	GooglePlacePhotoAttributionAllColumns            = googlePlacePhotoAttributionAllColumns
	GooglePlacePhotoAttributionColumnsWithoutDefault = googlePlacePhotoAttributionColumnsWithoutDefault
	GooglePlacePhotoAttributionColumnsWithDefault    = googlePlacePhotoAttributionColumnsWithDefault
	GooglePlacePhotoAttributionPrimaryKeyColumns     = googlePlacePhotoAttributionPrimaryKeyColumns
	GooglePlacePhotoAttributionGeneratedColumns      = googlePlacePhotoAttributionGeneratedColumns
)

// GetID get ID from model object
func (o *GooglePlacePhotoAttribution) GetID() string {
	return o.ID
}

// GetIDs extract IDs from model objects
func (s GooglePlacePhotoAttributionSlice) GetIDs() []string {
...
func (s GooglePlacePhotoAttributionSlice) GetIntfIDs() []interface{} {
...
func (s GooglePlacePhotoAttributionSlice) ToIDMap() map[string]*GooglePlacePhotoAttribution {
	result := make(map[string]*GooglePlacePhotoAttribution, len(s))
	for _, o := range s {
		result[o.ID] = o
	}
	return result
...
func (s GooglePlacePhotoAttributionSlice) ToUniqueItems() GooglePlacePhotoAttributionSlice {
	result := make(GooglePlacePhotoAttributionSlice, 0, len(s))
...
func (s GooglePlacePhotoAttributionSlice) FindItemByID(id string) *GooglePlacePhotoAttribution {
	for _, o := range s {
		if o.ID == id {
			return o
		}
...
func (s GooglePlacePhotoAttributionSlice) FindMissingItemIDs(expectedIDs []string) []string {
	if len(s) == 0 {
		return expectedIDs
	}
	result := []string{}
...
func (o GooglePlacePhotoAttributionSlice) InsertAll(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}
	...
	for i, row := range o {
		...
		wl, _ := columns.InsertColumnSet(
			...
			googlePlacePhotoAttributionColumnsWithDefault,
			googlePlacePhotoAttributionColumnsWithoutDefault,
			queries.NonZeroDefaultSet(googlePlacePhotoAttributionColumnsWithDefault, row),
		)
		if i == 0 {
			sql = "INSERT INTO `google_place_photo_attributions` " + "(`" + strings.Join(wl, "`,`") + "`)" + " VALUES "
		}
		sql += strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), len(vals)+1, len(wl))
		if i != len(o)-1 {
			sql += ","
		}
		valMapping, err := queries.BindMapping(googlePlacePhotoAttributionType, googlePlacePhotoAttributionMapping, wl)
		if err != nil {
			return 0, err
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to insert all from googlePlacePhotoAttribution slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by insertall for google_place_photo_attributions")
	}

	if len(googlePlacePhotoAttributionAfterInsertHooks) != 0 {
		for _, obj := range o {
...
func (o GooglePlacePhotoAttributionSlice) UpsertAll(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}

	nzDefaults := queries.NonZeroDefaultSet(googlePlacePhotoAttributionColumnsWithDefault, o[0])
	nzUniques := queries.NonZeroDefaultSet(mySQLGooglePlacePhotoAttributionUniqueColumns, o[0])
	if len(nzUniques) == 0 {
	...
	if !updateColumns.IsNone() && len(update) == 0 {
		return 0, errors.New("generated: unable to upsert google_place_photo_attributions, could not build update column list")
	}
	...
	if len(update) == 0 {
		fmt.Fprintf(
			buf,
			"INSERT IGNORE INTO `google_place_photo_attributions`(%s) VALUES %s",
		...
		fmt.Fprintf(
			buf,
			"INSERT INTO `google_place_photo_attributions`(%s) VALUES %s ON DUPLICATE KEY UPDATE ",
			strings.Join(strmangle.IdentQuoteSlice(dialect.LQ, dialect.RQ, insert), ","),
			strmangle.Placeholders(false, len(insert)*len(o), 1, len(insert)),
		)
	...
	query := buf.String()
	valueMapping, err := queries.BindMapping(googlePlacePhotoAttributionType, googlePlacePhotoAttributionMapping, insert)
	if err != nil {
		return 0, err
	}
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to upsert for google_place_photo_attributions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by upsert for google_place_photo_attributions")
	}

	if len(googlePlacePhotoAttributionAfterUpsertHooks) != 0 {
		for _, obj := range o {
...
// DeleteAllByPage delete all GooglePlacePhotoAttribution records from the slice.
...
func (s GooglePlacePhotoAttributionSlice) DeleteAllByPage(ctx context.Context, exec boil.ContextExecutor, limits ...int) (int64, error) {
	length := len(s)
	if length == 0 {
		return 0, nil
	}
...
// UpdateAllByPage update all GooglePlacePhotoAttribution records from the slice.
// This function updates data by pages to avoid exceeding Mysql limitation (max placeholders: 65535)
// Mysql Error 1390: Prepared statement contains too many placeholders.
func (s GooglePlacePhotoAttributionSlice) UpdateAllByPage(ctx context.Context, exec boil.ContextExecutor, cols M, limits ...int) (int64, error) {
	length := len(s)
	if length == 0 {
		return 0, nil
	}
...
// InsertAllByPage insert all GooglePlacePhotoAttribution records from the slice.
// This function inserts data by pages to avoid exceeding Mysql limitation (max placeholders: 65535)
// Mysql Error 1390: Prepared statement contains too many placeholders.
func (s GooglePlacePhotoAttributionSlice) InsertAllByPage(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns, limits ...int) (int64, error) {
	length := len(s)
	if length == 0 {
		return 0, nil
	}
	...
	// MySQL max placeholders = 65535
	chunkSize := MaxPageSize / reflect.ValueOf(&GooglePlacePhotoAttributionColumns).Elem().NumField()
...
// UpsertAllByPage upsert all GooglePlacePhotoAttribution records from the slice.
// This function upserts data by pages to avoid exceeding Mysql limitation (max placeholders: 65535)
// Mysql Error 1390: Prepared statement contains too many placeholders.
func (s GooglePlacePhotoAttributionSlice) UpsertAllByPage(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns, limits ...int) (int64, error) {
	length := len(s)
	if length == 0 {
		return 0, nil
	}
...
func (s GooglePlacePhotoAttributionSlice) LoadGooglePlacesByPage(ctx context.Context, e boil.ContextExecutor, mods ...qm.QueryMod) error {
	return s.LoadGooglePlacesByPageEx(ctx, e, DefaultPageSize, mods...)
}
func (s GooglePlacePhotoAttributionSlice) LoadGooglePlacesByPageEx(ctx context.Context, e boil.ContextExecutor, pageSize int, mods ...qm.QueryMod) error {
	if len(s) == 0 {
		return nil
	}
	for _, chunk := range chunkSlice[*GooglePlacePhotoAttribution](s, pageSize) {
...
func (s GooglePlacePhotoAttributionSlice) GetLoadedGooglePlaces() GooglePlaceSlice {
...
func (s GooglePlacePhotoAttributionSlice) LoadPhotoReferenceGooglePlacePhotoReferencesByPage(ctx context.Context, e boil.ContextExecutor, mods ...qm.QueryMod) error {
	return s.LoadPhotoReferenceGooglePlacePhotoReferencesByPageEx(ctx, e, DefaultPageSize, mods...)
}
func (s GooglePlacePhotoAttributionSlice) LoadPhotoReferenceGooglePlacePhotoReferencesByPageEx(ctx context.Context, e boil.ContextExecutor, pageSize int, mods ...qm.QueryMod) error {
	if len(s) == 0 {
		return nil
	}
	for _, chunk := range chunkSlice[*GooglePlacePhotoAttribution](s, pageSize) {
...
func (s GooglePlacePhotoAttributionSlice) GetLoadedPhotoReferenceGooglePlacePhotoReferences() GooglePlacePhotoReferenceSlice {
