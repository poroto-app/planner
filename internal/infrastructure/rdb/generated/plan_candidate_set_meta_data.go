...
func AddPlanCandidateSetMetaDatumHook(hookPoint boil.HookPoint, planCandidateSetMetaDatumHook PlanCandidateSetMetaDatumHook) {
	...
	case boil.AfterSelectHook:
		planCandidateSetMetaDatumAfterSelectMu.Lock()
		planCandidateSetMetaDatumAfterSelectHooks = append(planCandidateSetMetaDatumAfterSelectHooks, planCandidateSetMetaDatumHook)
		planCandidateSetMetaDatumAfterSelectMu.Unlock()
	case boil.BeforeInsertHook:
		planCandidateSetMetaDatumBeforeInsertMu.Lock()
		...
		planCandidateSetMetaDatumBeforeInsertMu.Unlock()
	case boil.AfterInsertHook:
		planCandidateSetMetaDatumAfterInsertMu.Lock()
		planCandidateSetMetaDatumAfterInsertHooks = append(planCandidateSetMetaDatumAfterInsertHooks, planCandidateSetMetaDatumHook)
		planCandidateSetMetaDatumAfterInsertMu.Unlock()
	case boil.BeforeUpdateHook:
		planCandidateSetMetaDatumBeforeUpdateMu.Lock()
		...
		planCandidateSetMetaDatumBeforeUpdateMu.Unlock()
	case boil.AfterUpdateHook:
		planCandidateSetMetaDatumAfterUpdateMu.Lock()
		planCandidateSetMetaDatumAfterUpdateHooks = append(planCandidateSetMetaDatumAfterUpdateHooks, planCandidateSetMetaDatumHook)
		planCandidateSetMetaDatumAfterUpdateMu.Unlock()
	case boil.BeforeDeleteHook:
		planCandidateSetMetaDatumBeforeDeleteMu.Lock()
		...
		planCandidateSetMetaDatumBeforeDeleteMu.Unlock()
	case boil.AfterDeleteHook:
		planCandidateSetMetaDatumAfterDeleteMu.Lock()
		planCandidateSetMetaDatumAfterDeleteHooks = append(planCandidateSetMetaDatumAfterDeleteHooks, planCandidateSetMetaDatumHook)
		planCandidateSetMetaDatumAfterDeleteMu.Unlock()
	case boil.BeforeUpsertHook:
		planCandidateSetMetaDatumBeforeUpsertMu.Lock()
		...
		planCandidateSetMetaDatumBeforeUpsertMu.Unlock()
	case boil.AfterUpsertHook:
		planCandidateSetMetaDatumAfterUpsertMu.Lock()
		planCandidateSetMetaDatumAfterUpsertHooks = append(planCandidateSetMetaDatumAfterUpsertHooks, planCandidateSetMetaDatumHook)
		planCandidateSetMetaDatumAfterUpsertMu.Unlock()
	}
}
...
func (q planCandidateSetMetaDatumQuery) One(ctx context.Context, exec boil.ContextExecutor) (*PlanCandidateSetMetaDatum, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "generated: failed to execute a one query for plan_candidate_set_meta_data")
	}
...
func (q planCandidateSetMetaDatumQuery) All(ctx context.Context, exec boil.ContextExecutor) (PlanCandidateSetMetaDatumSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "generated: failed to assign all query results to PlanCandidateSetMetaDatum slice")
	}
...
func (q planCandidateSetMetaDatumQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to count plan_candidate_set_meta_data rows")
	}
...
func (q planCandidateSetMetaDatumQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "generated: failed to check if plan_candidate_set_meta_data exists")
	}
...
func FindPlanCandidateSetMetaDatum(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*PlanCandidateSetMetaDatum, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "generated: unable to select from plan_candidate_set_meta_data")
	}
...
func (o *PlanCandidateSetMetaDatum) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("generated: no plan_candidate_set_meta_data provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to insert into plan_candidate_set_meta_data")
	}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to populate default values for plan_candidate_set_meta_data")
	}
...
func (o *PlanCandidateSetMetaDatum) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("generated: unable to update plan_candidate_set_meta_data, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to update plan_candidate_set_meta_data row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by update for plan_candidate_set_meta_data")
	}
...
func (q planCandidateSetMetaDatumQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to update all for plan_candidate_set_meta_data")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to retrieve rows affected for plan_candidate_set_meta_data")
	}
...
func (o PlanCandidateSetMetaDatumSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to update all in planCandidateSetMetaDatum slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to retrieve rows affected all in update all planCandidateSetMetaDatum")
	}
	return rowsAff, nil
}
...
func (o *PlanCandidateSetMetaDatum) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("generated: no plan_candidate_set_meta_data provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("generated: unable to upsert plan_candidate_set_meta_data, could not build update column list")
		}

		ret := strmangle.SetComplement(planCandidateSetMetaDatumAllColumns, strmangle.SetIntersect(insert, update))
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to upsert for plan_candidate_set_meta_data")
	}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to retrieve unique values for plan_candidate_set_meta_data")
	}
...
func (o *PlanCandidateSetMetaDatum) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("generated: no PlanCandidateSetMetaDatum provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to delete from plan_candidate_set_meta_data")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by delete for plan_candidate_set_meta_data")
	}
...
func (q planCandidateSetMetaDatumQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("generated: no planCandidateSetMetaDatumQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to delete all from plan_candidate_set_meta_data")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by deleteall for plan_candidate_set_meta_data")
	}
...
func (o PlanCandidateSetMetaDatumSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to delete all from planCandidateSetMetaDatum slice")
	}
...
func (o *PlanCandidateSetMetaDatumSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to reload all in PlanCandidateSetMetaDatumSlice")
	}
...
func PlanCandidateSetMetaDatumExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "generated: unable to check if plan_candidate_set_meta_data exists")
	}
...
var (
	PlanCandidateSetMetaDatumAllColumns            = planCandidateSetMetaDatumAllColumns
	PlanCandidateSetMetaDatumColumnsWithoutDefault = planCandidateSetMetaDatumColumnsWithoutDefault
	PlanCandidateSetMetaDatumColumnsWithDefault    = planCandidateSetMetaDatumColumnsWithDefault
	PlanCandidateSetMetaDatumPrimaryKeyColumns     = planCandidateSetMetaDatumPrimaryKeyColumns
	PlanCandidateSetMetaDatumGeneratedColumns      = planCandidateSetMetaDatumGeneratedColumns
)

// GetID get ID from model object
func (o *PlanCandidateSetMetaDatum) GetID() string {
	return o.ID
}

// GetIDs extract IDs from model objects
func (s PlanCandidateSetMetaDatumSlice) GetIDs() []string {
...
func (s PlanCandidateSetMetaDatumSlice) GetIntfIDs() []interface{} {
...
func (s PlanCandidateSetMetaDatumSlice) ToIDMap() map[string]*PlanCandidateSetMetaDatum {
	result := make(map[string]*PlanCandidateSetMetaDatum, len(s))
	for _, o := range s {
		result[o.ID] = o
	}
	return result
...
func (s PlanCandidateSetMetaDatumSlice) ToUniqueItems() PlanCandidateSetMetaDatumSlice {
	result := make(PlanCandidateSetMetaDatumSlice, 0, len(s))
...
func (s PlanCandidateSetMetaDatumSlice) FindItemByID(id string) *PlanCandidateSetMetaDatum {
	for _, o := range s {
		if o.ID == id {
			return o
		}
...
func (s PlanCandidateSetMetaDatumSlice) FindMissingItemIDs(expectedIDs []string) []string {
	if len(s) == 0 {
		return expectedIDs
	}
	result := []string{}
...
func (o PlanCandidateSetMetaDatumSlice) InsertAll(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}
	...
	for i, row := range o {
		...
		wl, _ := columns.InsertColumnSet(
			...
			planCandidateSetMetaDatumColumnsWithDefault,
			planCandidateSetMetaDatumColumnsWithoutDefault,
			queries.NonZeroDefaultSet(planCandidateSetMetaDatumColumnsWithDefault, row),
		)
		if i == 0 {
			sql = "INSERT INTO `plan_candidate_set_meta_data` " + "(`" + strings.Join(wl, "`,`") + "`)" + " VALUES "
		}
		sql += strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), len(vals)+1, len(wl))
		if i != len(o)-1 {
			sql += ","
		}
		valMapping, err := queries.BindMapping(planCandidateSetMetaDatumType, planCandidateSetMetaDatumMapping, wl)
		if err != nil {
			return 0, err
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to insert all from planCandidateSetMetaDatum slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by insertall for plan_candidate_set_meta_data")
	}

	if len(planCandidateSetMetaDatumAfterInsertHooks) != 0 {
		for _, obj := range o {
...
func (o PlanCandidateSetMetaDatumSlice) UpsertAll(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}

	nzDefaults := queries.NonZeroDefaultSet(planCandidateSetMetaDatumColumnsWithDefault, o[0])
	nzUniques := queries.NonZeroDefaultSet(mySQLPlanCandidateSetMetaDatumUniqueColumns, o[0])
	if len(nzUniques) == 0 {
	...
	if !updateColumns.IsNone() && len(update) == 0 {
		return 0, errors.New("generated: unable to upsert plan_candidate_set_meta_data, could not build update column list")
	}
	...
	if len(update) == 0 {
		fmt.Fprintf(
			buf,
			"INSERT IGNORE INTO `plan_candidate_set_meta_data`(%s) VALUES %s",
		...
		fmt.Fprintf(
			buf,
			"INSERT INTO `plan_candidate_set_meta_data`(%s) VALUES %s ON DUPLICATE KEY UPDATE ",
			strings.Join(strmangle.IdentQuoteSlice(dialect.LQ, dialect.RQ, insert), ","),
			strmangle.Placeholders(false, len(insert)*len(o), 1, len(insert)),
		)
	...
	query := buf.String()
	valueMapping, err := queries.BindMapping(planCandidateSetMetaDatumType, planCandidateSetMetaDatumMapping, insert)
	if err != nil {
		return 0, err
	}
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to upsert for plan_candidate_set_meta_data")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by upsert for plan_candidate_set_meta_data")
	}

	if len(planCandidateSetMetaDatumAfterUpsertHooks) != 0 {
		for _, obj := range o {
...
// DeleteAllByPage delete all PlanCandidateSetMetaDatum records from the slice.
...
func (s PlanCandidateSetMetaDatumSlice) DeleteAllByPage(ctx context.Context, exec boil.ContextExecutor, limits ...int) (int64, error) {
	length := len(s)
	if length == 0 {
		return 0, nil
	}
...
// UpdateAllByPage update all PlanCandidateSetMetaDatum records from the slice.
// This function updates data by pages to avoid exceeding Mysql limitation (max placeholders: 65535)
// Mysql Error 1390: Prepared statement contains too many placeholders.
func (s PlanCandidateSetMetaDatumSlice) UpdateAllByPage(ctx context.Context, exec boil.ContextExecutor, cols M, limits ...int) (int64, error) {
	length := len(s)
	if length == 0 {
		return 0, nil
	}
...
// InsertAllByPage insert all PlanCandidateSetMetaDatum records from the slice.
// This function inserts data by pages to avoid exceeding Mysql limitation (max placeholders: 65535)
// Mysql Error 1390: Prepared statement contains too many placeholders.
func (s PlanCandidateSetMetaDatumSlice) InsertAllByPage(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns, limits ...int) (int64, error) {
	length := len(s)
	if length == 0 {
		return 0, nil
	}
	...
	// MySQL max placeholders = 65535
	chunkSize := MaxPageSize / reflect.ValueOf(&PlanCandidateSetMetaDatumColumns).Elem().NumField()
...
// UpsertAllByPage upsert all PlanCandidateSetMetaDatum records from the slice.
// This function upserts data by pages to avoid exceeding Mysql limitation (max placeholders: 65535)
// Mysql Error 1390: Prepared statement contains too many placeholders.
func (s PlanCandidateSetMetaDatumSlice) UpsertAllByPage(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns, limits ...int) (int64, error) {
	length := len(s)
	if length == 0 {
		return 0, nil
	}
...
func (s PlanCandidateSetMetaDatumSlice) LoadPlanCandidateSetsByPage(ctx context.Context, e boil.ContextExecutor, mods ...qm.QueryMod) error {
	return s.LoadPlanCandidateSetsByPageEx(ctx, e, DefaultPageSize, mods...)
}
func (s PlanCandidateSetMetaDatumSlice) LoadPlanCandidateSetsByPageEx(ctx context.Context, e boil.ContextExecutor, pageSize int, mods ...qm.QueryMod) error {
	if len(s) == 0 {
		return nil
	}
	for _, chunk := range chunkSlice[*PlanCandidateSetMetaDatum](s, pageSize) {
...
func (s PlanCandidateSetMetaDatumSlice) GetLoadedPlanCandidateSets() PlanCandidateSetSlice {
